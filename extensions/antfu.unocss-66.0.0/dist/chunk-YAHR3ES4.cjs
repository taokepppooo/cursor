...
var r = !o && globalThis.fetch || _chunkJRN2XB6Pcjs.ei;
var p = !o && globalThis.Blob || _chunkJRN2XB6Pcjs.Ze;
var F = !o && globalThis.File || _chunkJRN2XB6Pcjs.Yr;
var h = !o && globalThis.FormData || _chunkJRN2XB6Pcjs.Zt;
var n = !o && globalThis.Headers || _chunkJRN2XB6Pcjs.ae;
var c = !o && globalThis.Request || _chunkJRN2XB6Pcjs.Xe;
var R = !o && globalThis.Response || _chunkJRN2XB6Pcjs.H;
var T = !o && globalThis.AbortController || _chunkJRN2XB6Pcjs.nn;
  ...
  const $fetchRaw = async function $fetchRaw2(_request, _options = {}) {
    ...
    if (typeof context.request === "string") {
      if (context.options.baseURL) {
        context.request = _chunkCDGJIMJGcjs.withBase.call(void 0, context.request, context.options.baseURL);
      }
      if (context.options.query) {
        context.request = _chunkCDGJIMJGcjs.withQuery.call(void 0, context.request, context.options.query);
...
function createNodeFetch() {
  ...
  const httpAgent = new _http2.default.Agent(agentOptions);
  const httpsAgent = new _https2.default.Agent(agentOptions);
...
exports.FetchError = FetchError; exports.createFetchError = createFetchError; exports.createFetch = createFetch; exports.createNodeFetch = createNodeFetch; exports.fetch = fetch; exports.Headers = Headers; exports.AbortController = AbortController; exports.ofetch = ofetch; exports.$fetch = $fetch;
