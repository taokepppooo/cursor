...
var en = __importStar(__webpack_require__(2019));
var zh_cn = __importStar(__webpack_require__(900));
var zh_tw = __importStar(__webpack_require__(5591));
var fr = __importStar(__webpack_require__(1435));
var de = __importStar(__webpack_require__(7111));
var it = __importStar(__webpack_require__(9380));
var es = __importStar(__webpack_require__(6551));
var ja = __importStar(__webpack_require__(5222));
var ko = __importStar(__webpack_require__(3047));
var ru = __importStar(__webpack_require__(1970));
var bg = __importStar(__webpack_require__(7072));
var hu = __importStar(__webpack_require__(6919));
var pt_br = __importStar(__webpack_require__(2273));
var tr = __importStar(__webpack_require__(3581));
...
var _os = _interopRequireDefault(__webpack_require__(2037));
...
const {PassThrough: PassThroughStream} = __webpack_require__(9955);
...
const stream = __webpack_require__(9955);
const {promisify} = __webpack_require__(3837);
...
const path = __webpack_require__(1017);
const Module = __webpack_require__(8188);
const fs = __webpack_require__(7147);
...
const { PassThrough } = __webpack_require__(9955);
...
const {default: LinesAndColumns} = __webpack_require__(8217);
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, localize_1.initialize)();
        context.subscriptions.push(vscode.commands.registerCommand('extension.conventionalCommits', (0, conventional_commits_1.default)()), vscode.commands.registerCommand('extension.conventionalCommits.resetGlobalState', () => {
            context.globalState.update('version', '0.0.0');
            const title = (0, localize_1.default)('extension.name');
            const message = (0, localize_1.getSourcesLocalize)('resetMessage');
...
function getGitAPI() {
    ...
    if (!(vscodeGit === null || vscodeGit === void 0 ? void 0 : vscodeGit.exports.getAPI(1))) {
        output.error('getGitAPI', (0, localize_1.getSourcesLocalize)('vscodeGitNotFound'), true);
    }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (_arg) {
            ...
            if (repo)
                ...
                output.error('getRepository', (0, localize_1.getSourcesLocalize)('repositoryNotFoundInPath') + _arg, true);
            }
        }
        if (git.repositories.length === 0) {
            output.error('getRepository', (0, localize_1.getSourcesLocalize)('repositoriesEmpty'), true);
        }
        ...
        const [{ index }] = (yield (0, quick_pick_1.default)({
            placeholder: (0, localize_1.getSourcesLocalize)('promptRepositoryPlaceholder'),
            items,
        })).activeItems;
    ...
    return function conventionalCommits(repoUri) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // 5. get message
                const commitMessage = yield (0, prompts_1.default)({
                ...
                const message = (0, commit_message_1.serialize)(commitMessage);
                output.info(`message:\n${message}`);
                ...
                if (showEditor) {
                    ...
                    yield (0, editor_1.default)(repository);
...
function getNLS(locale = '') {
    ...
    let content = '';
    try {
        content = (0, fs_1.readFileSync)((0, path_1.resolve)(exports.rootPath, packageName), 'utf-8');
    }
    catch (e) {
        ...
        content = (0, fs_1.readFileSync)((0, path_1.resolve)(exports.rootPath, `package.nls.json`), 'utf-8');
    }
    finally {
...
function showNewVersionNotes(id, context, force = false) {
    return __awaiter(this, void 0, void 0, function* () {
        if (configuration.get('showNewVersionNotes') || force) {
            ...
            const welcomeNewVersion = (0, localize_2.getSourcesLocalize)('output.welcomeNewVersion');
            const showReleaseNotes = (0, localize_2.getSourcesLocalize)('output.showReleaseNotes');
            const dontShowThisAgain = (0, localize_2.getSourcesLocalize)('output.dontShowThisAgain');
...
const gitmojis = __webpack_require__(8653);
const configuration = __webpack_require__(1058);
...
function prompts({ gitmoji, showEditor, emojiFormat, lineBreak, promptScopes, promptBody, promptFooter, promptCI, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const conventionalCommitsTypes = (0, conventional_commit_types_i18n_1.default)(localize_1.locale).types;
        ...
        function getTypeItems() {
            ...
            return typeEnum.map(function (type) {
                ...
                return {
                    label: type,
                    description: '',
                    detail: (0, localize_1.getPromptLocalize)('type.fromCommitlintConfig'),
                };
            });
        }
        function getScopePrompt() {
            const name = 'scope';
            const placeholder = (0, localize_1.getPromptLocalize)('scope.placeholder');
            const scopeEnum = commitlint_1.default.getScopeEnum();
            const noneItem = {
                label: (0, localize_1.getPromptLocalize)('scope.noneItem.label'),
                description: '',
                detail: (0, localize_1.getPromptLocalize)('scope.noneItem.detail'),
                alwaysShow: true,
            };
            if (scopeEnum.length) {
                return {
            ...
            return {
                ...
                newItem: {
                    label: (0, localize_1.getPromptLocalize)('scope.newItem.label'),
                    description: '',
                    detail: (0, localize_1.getPromptLocalize)('scope.newItem.detail'),
                    alwaysShow: true,
                    placeholder: (0, localize_1.getPromptLocalize)('scope.newItem.placeholder'),
                },
                noneItem,
                newItemWithoutSetting: {
                    label: (0, localize_1.getPromptLocalize)('scope.newItemWithoutSetting.label'),
                    description: '',
                    detail: (0, localize_1.getPromptLocalize)('scope.newItemWithoutSetting.detail'),
                    alwaysShow: true,
                    placeholder: (0, localize_1.getPromptLocalize)('scope.newItem.placeholder'),
                },
                validate(input) {
                ...
                storeGlobal: configuration.get('storeScopesGlobally'),
            };
        }
        const questions = [
            {
                type: prompt_types_1.PROMPT_TYPES.QUICK_PICK,
                name: 'type',
                placeholder: (0, localize_1.getPromptLocalize)('type.placeholder'),
                items: getTypeItems(),
                validate(input) {
            ...
            getScopePrompt(),
            {
                type: prompt_types_1.PROMPT_TYPES.QUICK_PICK,
                name: 'gitmoji',
                placeholder: (0, localize_1.getPromptLocalize)('gitmoji.placeholder'),
                ...
                noneItem: {
                    label: (0, localize_1.getPromptLocalize)('gitmoji.noneItem.label'),
                    description: '',
                    detail: (0, localize_1.getPromptLocalize)('gitmoji.noneItem.detail'),
                    alwaysShow: true,
                },
            },
            {
                type: prompt_types_1.PROMPT_TYPES.QUICK_PICK,
                name: 'ci',
                placeholder: (0, localize_1.getPromptLocalize)('ci.placeholder'),
                items: [
                    {
                        label: 'Yes',
                        description: (0, localize_1.getPromptLocalize)('ci.accept.label'),
                        detail: (0, localize_1.getPromptLocalize)('ci.accept.detail'),
                    },
                ],
                noneItem: {
                    label: 'No',
                    description: (0, localize_1.getPromptLocalize)('ci.decline.label'),
                    detail: (0, localize_1.getPromptLocalize)('ci.decline.detail'),
                    alwaysShow: true,
                },
            },
            {
                ...
                name: 'subject',
                placeholder: (0, localize_1.getPromptLocalize)('subject.placeholder'),
                validate(input) {
                    const { type, scope, gitmoji, ci } = commitMessage;
                    const serializedSubject = (0, commit_message_1.serializeSubject)({
                        gitmoji,
                        subject: input,
                    });
                    ...
                    if (subjectError) {
                        if (gitmoji) {
                            subjectError += ' (';
                            subjectError += (0, localize_1.getPromptLocalize)('subject.error.including');
                            subjectError += (0, localize_1.getPromptLocalize)('subject.error.gitmoji');
                            subjectError += gitmoji;
                            subjectError += ')';
                        }
                        return subjectError;
                    }
                    let headerError = commitlint_1.default.lintHeader((0, commit_message_1.serializeHeader)({
                        type,
                        scope,
                        gitmoji,
                        subject: input,
                    ...
                    if (headerError) {
                        headerError += ' (';
                        headerError += (0, localize_1.getPromptLocalize)('subject.error.including');
                        headerError += (0, localize_1.getPromptLocalize)('subject.error.type');
                        headerError += type;
                        if (scope) {
                            headerError += ', ';
                            headerError += (0, localize_1.getPromptLocalize)('subject.error.scope');
                            headerError += scope;
                        }
                        if (gitmoji) {
                            headerError += ', ';
                            headerError += (0, localize_1.getPromptLocalize)('subject.error.gitmoji');
                            headerError += gitmoji;
                        }
                        headerError += ')';
                        return headerError;
            ...
            },
            {
                type: prompt_types_1.PROMPT_TYPES.INPUT_BOX,
                name: 'body',
                placeholder: (0, localize_1.getPromptLocalize)('body.placeholder'),
                validate(input) {
            ...
            },
            {
                type: prompt_types_1.PROMPT_TYPES.INPUT_BOX,
                name: 'footer',
                placeholder: (0, localize_1.getPromptLocalize)('footer.placeholder'),
                validate(input) {
        ...
        promptStatuses
            ...
            .forEach((value, index) => {
            var _a, _b, _c;
            commitMessage[questions[index].name] =
                (_c = (_b = (_a = questions[index]).format) === null || _b === void 0 ? void 0 : _b.call(_a, value)) !== null && _c !== void 0 ? _c : value;
        });
...
function createQuickPick({ placeholder, items = [], activeItems = [], value, step, totalSteps, noneItem, buttons = [], }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const promptStatus = yield (0, quick_pick_1.default)({
            placeholder,
...
function createConfigurableQuickPick({ placeholder, value, step, totalSteps, configurationKey, newItem, noneItem, activeItems = [], newItemWithoutSetting, validate = () => undefined, buttons, storeGlobal = false, }) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const currentValues = configuration.get(configurationKey);
        const workspaceConfigurationItemInfo = {
            description: '',
            detail: (0, localize_1.default)('extension.sources.prompt.fromWorkspaceConfiguration'),
        };
        ...
        if (promptStatus.activeItems[0] &&
            ...
            if (promptStatus.value) {
                configuration.update(configurationKey, [...currentValues, promptStatus.value], storeGlobal);
...
var PlainValue = __webpack_require__(8846);
var resolveSeq = __webpack_require__(5328);
var Schema = __webpack_require__(1993);
...
var PlainValue = __webpack_require__(8846);
var resolveSeq = __webpack_require__(5328);
var warnings = __webpack_require__(1802);
...
var PlainValue = __webpack_require__(8846);
var parseCst = __webpack_require__(6986);
__webpack_require__(5328);
var Document$1 = __webpack_require__(8499);
var Schema = __webpack_require__(1993);
var warnings = __webpack_require__(1802);
...
module.exports = __webpack_require__(8349).YAML
