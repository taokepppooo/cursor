...
export declare const FieldWrapper: <T extends new (...args: any[]) => FieldInterface & EditorContextInterface & FieldValueConsumerInterface>(base: T) => {
    new (...args: any[]): {
...
//# sourceMappingURL=field-wrapper-mixin.d.ts.map