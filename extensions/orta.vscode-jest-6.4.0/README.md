...
## Releases 
- **Current** ([v6.4.0](https://github.com/jest-community/vscode-jest/releases/tag/v6.4.0)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v6.md#v640)
- **Previous** ([v6.2.5](https://github.com/jest-community/vscode-jest/releases/tag/v6.2.5)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v6.md#v625)
