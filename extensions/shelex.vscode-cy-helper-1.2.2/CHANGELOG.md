...
## [1.2.2] - 2020-04-01
### Fixed
 - [#48](https://github.com/90poe/vscode-cy-helper/issues/48), address issue when errors are thrown for some commands on initialisation it blocks other functionality
...
### Fixed
 - [#43](https://github.com/90poe/vscode-cy-helper/issues/43), solved by checking if package.json exist in sub-folders. In case it exist we treat folder as root for new terminal to support Cypress Run and Cypress Open code lenses for nested projects and calculate corresponding relative path to spec or root path.

## [1.2.0] - 2020-03-19
### Added
 - [#40](https://github.com/90poe/vscode-cy-helper/issues/40), autocomplete for jquery locators
...
## [1.1.0] - 2020-03-15
### Added
 - [#39](https://github.com/90poe/vscode-cy-helper/issues/39), autocompletion for cy.type keyPress sequences

## [1.0.3] - 2020-02-15
### Fixed
 - [#34](https://github.com/90poe/vscode-cy-helper/issues/34), capitalize absolute windows path when lowercase used

## [1.0.2] - 2020-01-29
### Fixed
 - [#34](https://github.com/90poe/vscode-cy-helper/issues/34), handle path with spaces when passing file to open cypress command
### Added
 - [#30](https://github.com/90poe/vscode-cy-helper/issues/30), option to run spec in cypress

## [1.0.1] - 2020-12-02
### Fixed
 - [#32](https://github.com/90poe/vscode-cy-helper/issues/32), for fixture definition check if resulting file exists
...
## [0.8.2] - 2020-09-21
### Fixed
 - check optional flag when parsing typescript arguments, address [#27](https://github.com/90poe/vscode-cy-helper/issues/27)
### Changed
