...
- Fix [#94](https://github.com/pucelle/vscode-css-navigation/issues/94) - error "Duplicate capture group name" and cause plugin crash, thanks to `onetrev@github` .
...
- Fix [#93](https://github.com/pucelle/vscode-css-navigation/issues/93), will not miss sass nesting selectors when selector name contains interpolation `#{...}`.
...
- Changes README by [#91](https://github.com/pucelle/vscode-css-navigation/issues/91).
