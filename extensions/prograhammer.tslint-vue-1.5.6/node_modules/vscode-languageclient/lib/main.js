...
const configuration_proposed_1 = require("./configuration.proposed");
const workspaceFolders_proposed_1 = require("./workspaceFolders.proposed");
__export(require("./configuration.proposed"));
__export(require("./workspaceFolders.proposed"));
function ProposedProtocol(client) {
    let result = [];
    result.push(new workspaceFolders_proposed_1.WorkspaceFoldersFeature(client));
    result.push(new configuration_proposed_1.ConfigurationFeature(client));
    return result;
}
